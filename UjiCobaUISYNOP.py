...
Original file is located at
    https://colab.research.google.com/drive/1gLXUd9wLFlEmK9yDNnVfoTGKjCzwg7j8
"""
...
def main():
    img = st.image('login.png', width=120), st.image('download-removebg-preview.png', width=120)
